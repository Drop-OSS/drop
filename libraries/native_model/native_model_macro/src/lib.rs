...
use crate::method::{
    ...
    generate_native_model_encode_body, generate_native_model_id, generate_native_model_version,
};
...
pub fn native_model(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let native_model_decode_upgrade_body_fn =
        generate_native_model_decode_upgrade_body(&attrs, struct_name);
