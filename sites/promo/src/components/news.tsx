          ...
          {featuredPosts.map((post) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-8">
                ...
                <div className="mt-2 flex-1 text-sm/6 text-zinc-400">{post.excerpt}</div>
      ...
      {posts.map((post) => (
        ...
        >
          <div>
            ...
            {postAuthors[post.author ?? ""] && (
              <div className="mt-2.5 flex items-center gap-3">
                ...
                <div className="text-sm/5 text-zinc-300">{postAuthors[post.author ?? ""].name}</div>
              </div>
            )}
          </div>
          <div className="sm:col-span-2 sm:max-w-2xl">
            ...
            <div className="mt-4">
              <Link href={post.url} className="flex items-center gap-1 text-sm/5 font-medium">
                <span className="absolute inset-0" />
                Read more
    ...
    <main className="overflow-hidden">
      ...
      <Container>
        ...
        <Lead className="mt-6 max-w-3xl">
          Check out what&apos;s new and what&apos;s upcoming in Drop through our hand-written
          articles by the core team of Drop.
        </Lead>
      </Container>
