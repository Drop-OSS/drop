  ...
  return (
    <div className="relative pt-20 pb-16 text-center sm:py-24">
      ...
      <p className="mx-auto mt-6 max-w-xs text-sm/6 text-zinc-400">
        Get started hosting Drop in 10 minutes or less, and explore all the features it has to
        offer.
      </p>
      <div className="mt-6">
    ...
    <>
      ...
      <div>
        ...
        <SitemapLinks>
          ...
          <SitemapLink href="https://developer.droposs.org/">Developers</SitemapLink>
        </SitemapLinks>
      </div>
      <div>
        <SitemapHeading>Support</SitemapHeading>
        <SitemapLinks>
          <SitemapLink href="https://discord.gg/ACq4qZp4a9">Discord</SitemapLink>
...
function Copyright() {
  return (
    <div className="text-xs text-zinc-400">
      &copy; {new Date().getFullYear()} Drop OSS. Website licensed under AGPLv3 and Tailwind UI Plus
      (where applicable).
    </div>
  );
}
